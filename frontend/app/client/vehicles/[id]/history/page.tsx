    ...
    return (
      <ClientPageWrapper className="flex items-center justify-center h-[60vh]">
        <ClientCard className="max-w-md text-center p-12">
          ...
          <h2 className="text-2xl font-bold text-[#050505] mb-4">{error || "Véhicule non trouvé"}</h2>
    ...
    <ClientPageWrapper className="space-y-12 pb-20">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex-1 text-center md:text-left">
            ...
            <h1 className="mb-2 text-4xl sm:text-4xl font-bold tracking-tight leading-none">
              {history.marque} <span className="text-blue-500">{history.modele}</span>
            </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full md:w-auto">
             <div className="p-8 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md">
                <div className="flex items-center gap-3 mb-4">
                   ...
                   <span className="text-[10px] font-bold uppercase tracking-wide text-[#B0B3B8]">Kilométrage</span>
                </div>
                <p className="text-3xl font-bold text-white">{history.kilometrage.toLocaleString()} <span className="text-sm font-bold text-[#8A8D91]">KM</span></p>
             </div>
             <div className="p-8 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md">
                <div className="flex items-center gap-3 mb-4">
                   <div className="h-10 w-10 rounded-xl bg-blue-600 flex items-center justify-center shadow-lg shadow-blue-600/20">
                   ...
                   <span className="text-[10px] font-bold uppercase tracking-wide text-[#B0B3B8]">Services</span>
                </div>
                <p className="text-3xl font-bold text-white">{history.total_interventions}</p>
             </div>
          </div>
        </div>
      </motion.div>
      ...
      <Tabs defaultValue="overview" className="w-full" onValueChange={(v) => setActiveTab(v as any)}>
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <TabsList className="bg-white p-2 rounded-lg shadow-sm h-auto gap-2 border border-slate-50 self-start">
            <TabsTrigger value="overview" className="rounded-lg px-8 py-3 font-bold uppercase tracking-wide text-[10px] data-[state=active]:bg-blue-600 data-[state=active]:text-white">
              {t('vehicleHistory.overview')}
            </TabsTrigger>
            <TabsTrigger value="interventions" className="rounded-lg px-8 py-3 font-bold uppercase tracking-wide text-[10px] data-[state=active]:bg-blue-600 data-[state=active]:text-white">
              {t('vehicleHistory.interventions')} ({interventions.length})
            </TabsTrigger>
            <TabsTrigger value="appointments" className="rounded-lg px-8 py-3 font-bold uppercase tracking-wide text-[10px] data-[state=active]:bg-blue-600 data-[state=active]:text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
               ...
               <ClientCard className="lg:col-span-2">
                  <div className="flex items-center gap-4 mb-8">
                     <div className="h-14 w-14 rounded-lg bg-[#F0F2F5] flex items-center justify-center">
                        <History className="h-7 w-7 text-[#B0B3B8]" />
                     </div>
                     <div>
                        <h2 className="text-2xl font-bold text-[#050505] tracking-tight">Informations Générales</h2>
                        <p className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide">Fiche technique du véhicule</p>
                     </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                     {[
                       ...
                       <div key={i} className="group">
                          <p className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide mb-2 flex items-center gap-2">
                             <item.icon className="h-3.5 w-3.5 text-blue-500" />
                             {item.label}
                          </p>
                          <p className="text-lg font-bold text-[#050505] group-hover:text-blue-600 transition-colors">{item.value}</p>
                       </div>
                     ))}
                  </div>
               </ClientCard>
               ...
               {/* Cost Summary Card */}
               <ClientCard className="border-2 border-blue-50 bg-blue-50/10">
                  <div className="text-center space-y-6">
                     <div className="h-20 w-20 rounded-full bg-blue-600 flex items-center justify-center mx-auto shadow-sm shadow-blue-600/20">
                        <DollarSign className="h-10 w-10 text-white" />
                     </div>
                     <div>
                        <h3 className="text-xl font-bold text-[#050505] mb-1">{t('vehicleHistory.totalCost')}</h3>
                        <p className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide">Cumul de toutes les interventions</p>
                     </div>
                     ...
                     <div className="pt-6 border-t border-blue-100 grid grid-cols-2 gap-4">
                        <div>
                           <p className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide mb-1">Rendez-vous</p>
                           <p className="text-xl font-bold text-[#050505]">{history.total_rdv}</p>
                        </div>
                        <div>
                           <p className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide mb-1">Interventions</p>
                           <p className="text-xl font-bold text-[#050505]">{history.total_interventions}</p>
                        </div>
                     </div>
                  </div>
               </ClientCard>
            ...
            {interventions.length === 0 ? (
              ...
              <div className="space-y-6">
                {interventions.map((intervention, idx) => (
                  ...
                  >
                    <ClientCard className="p-0 overflow-hidden border-none shadow-sm group">
                      <div className="flex flex-col lg:flex-row">
                        <div className="bg-[#F0F2F5] p-8 flex flex-col justify-center items-center text-center lg:w-48 border-b lg:border-b-0 lg:border-r border-[#E4E6EB] group-hover:bg-blue-50 transition-colors">
                           <span className="text-3xl font-bold text-[#050505] mb-1 leading-none">{new Date(intervention.date_intervention).getDate()}</span>
                           <span className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide">{new Date(intervention.date_intervention).toLocaleDateString('fr-FR', { month: 'short', year: 'numeric' })}</span>
                        </div>
                        <div className="flex-1 p-8">
                           <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
                              <div>
                                 <div className="flex items-center gap-3 mb-1">
                                    <h3 className="text-xl font-bold text-[#050505] tracking-tight group-hover:text-blue-600 transition-colors">
                                 ...
                                 <p className="text-xs font-bold text-[#B0B3B8] flex items-center gap-2 uppercase tracking-wide">
                              ...
                              <div className="text-right">
                                 ...
                                 <p className="text-2xl font-bold text-[#050505]">{formatCurrency(intervention.cout_total)}</p>
                              </div>
                           </div>
                           <p className="text-[#65676B] font-medium leading-relaxed bg-white border border-[#E4E6EB] rounded-lg p-5 italic">
              ...
              <div className="space-y-6">
                {appointments.map((appointment, idx) => (
                  <motion.div
                    ...
                    transition={{ delay: idx * 0.05 }}
                  >
                    <ClientCard className="p-8 border-none shadow-sm group">
                      <div className="flex flex-col sm:flex-row items-center gap-4">
                        <div className="h-20 w-20 rounded-lg bg-[#F0F2F5] flex flex-col items-center justify-center border border-[#E4E6EB] group-hover:bg-blue-50 transition-colors">
                           <span className="text-2xl font-bold text-[#050505] leading-none mb-1">{new Date(appointment.date_rdv).getDate()}</span>
                           <span className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide">{new Date(appointment.date_rdv).toLocaleDateString('fr-FR', { month: 'short' })}</span>
                        </div>
                        <div className="flex-1 text-center sm:text-left">
                           <div className="flex flex-wrap items-center justify-center sm:justify-start gap-4 mb-2">
                              ...
                              <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wide border ${
                                 ...
                                 appointment.statut === 'ANNULE' ? 'bg-blue-50 text-blue-600 border-blue-100' :
                                 'bg-blue-50 text-blue-600 border-blue-100'
                              }`}>
                                 {appointment.statut}
                              </span>
                           </div>
                           <div className="flex flex-wrap items-center justify-center sm:justify-start gap-x-6 gap-y-2 text-xs font-bold text-[#B0B3B8] uppercase tracking-wide">
                        ...
                        <div className="max-w-xs text-center sm:text-right">
                           <p className="text-[10px] font-bold text-[#B0B3B8] uppercase tracking-wide mb-1">Motif</p>
                           <p className="text-sm font-bold text-[#65676B] italic line-clamp-2">{appointment.motif || '—'}</p>
                        </div>
                      </div>
                    </ClientCard>
                  </motion.div>
      ...
      <motion.div
        ...
        className="rounded-xl bg-blue-600 p-12 text-center relative overflow-hidden text-white"
      >
        <div className="absolute inset-0 bg-[url('/grid.svg')] opacity-10" />
        <div className="relative z-10">
          <Sparkles className="h-12 w-12 text-white/40 mx-auto mb-6" />
          <h2 className="text-3xl font-bold mb-4 tracking-tight">Besoin d'un dossier papier ?</h2>
          <p className="text-blue-100 font-medium max-w-lg mx-auto mb-8">
