    ...
    <ClientPageWrapper className="space-y-12 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {filteredItems.map((item, idx) => {
          ...
          return (
            ...
            >
              <ClientCard 
                className="group h-full flex flex-col p-8 border-none shadow-sm hover:shadow-md hover:shadow-blue-500/10 transition-all duration-500 cursor-pointer"
              >
                <div className={`mb-6 flex h-14 w-14 items-center justify-center rounded-lg ${colors[item.color]} shadow-inner group-hover:scale-110 transition-transform`}>
                ...
                <div className="flex-1 space-y-3 mb-8">
                  ...
                  <p className="text-[#B0B3B8] text-sm font-medium leading-relaxed">
                    {item.description}
                  </p>
                </div>

                <div className="flex items-center justify-between pt-4 border-t border-slate-50">
                   <span className="text-[10px] font-bold text-slate-300 uppercase tracking-wide">{item.type}</span>
                   <div className="h-10 w-10 rounded-full bg-[#F0F2F5] flex items-center justify-center text-[#B0B3B8] group-hover:bg-blue-600 group-hover:text-white transition-all">
      ...
      <div className="space-y-8 mt-12">
        <div className="flex items-center justify-between px-4">
          <div>
            <h2 className="text-3xl font-bold text-[#050505] tracking-tight">{t('assistance.frequentQuestions')}</h2>
            <p className="text-[#B0B3B8] text-sm font-medium mt-1">Réponses rapides aux questions courantes.</p>
          </div>
        ...
        <div className="grid gap-4">
          {[
            ...
            >
              <ClientCard className="p-6 border-none shadow-lg shadow-slate-100 hover:shadow-sm transition-all group">
                <div className="flex items-start gap-4">
                   <div className="h-8 w-8 shrink-0 flex items-center justify-center rounded-lg bg-[#E4E6EB] text-[#B0B3B8] group-hover:bg-blue-50 group-hover:text-blue-500 transition-colors mt-0.5 font-bold text-xs">
                      Q
                   </div>
                   <div>
                     <h3 className="font-bold text-[#050505] mb-2">{faq.question}</h3>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="relative rounded-xl bg-gradient-to-br from-blue-600 to-blue-800 p-12 text-white overflow-hidden shadow-md"
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
           ...
           <div className="flex flex-col sm:flex-row gap-4 shrink-0">
              <ClientButton variant="secondary" className="bg-white text-blue-600 hover:bg-blue-50 border-none px-8 py-6 h-auto rounded-lg shadow-sm">
                 <Phone className="h-5 w-5 mr-3" />
                 71 111 222
              </ClientButton>
              <ClientButton variant="primary" className="bg-blue-600 hover:bg-blue-700 border-none px-8 py-6 h-auto rounded-lg shadow-sm">
                 Nous contacter
