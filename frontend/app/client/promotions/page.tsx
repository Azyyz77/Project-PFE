  ...
  return (
    <ClientPageWrapper className="space-y-12 pb-20">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="max-w-2xl text-center md:text-left">
            ...
            <h1 className="mb-4 text-4xl sm:text-6xl font-black tracking-tight leading-none">
              Nos <span className="text-red-500">Promotions</span>
            </h1>
                ...
                >
                  <ClientCard className="h-full flex flex-col p-0 overflow-hidden border-none shadow-xl shadow-slate-200/40 group-hover:shadow-red-500/10 transition-all duration-500">
                    ...
                    <div className="relative h-56 w-full overflow-hidden">
                      ...
                      {isActive && daysLeft <= 7 && (
                        <div className="absolute top-4 right-4 bg-red-600 text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-2 shadow-xl animate-pulse">
                    ...
                    <div className="p-8 flex flex-col flex-1">
                      <div className="flex items-center gap-2 mb-4 text-red-500">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em]">Promotion Exclusive</span>
                      </div>

                      <h3 className="text-2xl font-black text-slate-800 tracking-tight mb-4 group-hover:text-red-600 transition-colors">
                        {promo.titre}
                      </h3>
                      ...
                      <div className="mt-auto space-y-6">
                        <div className="flex items-center justify-between p-4 rounded-2xl bg-slate-50 border border-slate-100">
                          <div className="space-y-1">
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Validité</p>
      ...
      <motion.div
        ...
        className="rounded-[3rem] bg-slate-100 p-12 text-center relative overflow-hidden"
      >
        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-64 w-64 bg-red-500/5 blur-3xl rounded-full" />
        <TrendingUp className="h-12 w-12 text-red-500 mx-auto mb-6" />
        <h2 className="text-3xl font-black text-slate-800 mb-4 tracking-tight">Ne manquez aucune opportunité</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
          <input 
            ...
            className="flex-1 bg-white border-none rounded-2xl px-6 py-4 font-medium shadow-sm focus:ring-4 focus:ring-red-500/10 outline-none"
          />
