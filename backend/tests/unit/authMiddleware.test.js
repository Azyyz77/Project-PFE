...
describe('authMiddleware', () => {
  it('UT01: returns 401 when Authorization header is missing', () => {
  ...
  it('UT02: returns 401 when token is missing after "Bearer "', () => {
  ...
  it('UT03: returns 401 for an expired JWT token', () => {
  ...
  it('UT04: returns 401 for a tampered/invalid JWT token', () => {
  ...
  it('UT05: populates req.user and calls next() for a valid token', () => {
  ...
  it('UT06: populates req.user with agence_id=undefined when not in token', () => {
